...
#             self.root.after(10, self.call_generate_segmentation_external, filename, (width, height), modality_path,
#                             test_results_path)
#
...
#
#     #se face call si la property extractor dupa ce se obtine imaginea aia segmentata cu valori 0,1,2,3
